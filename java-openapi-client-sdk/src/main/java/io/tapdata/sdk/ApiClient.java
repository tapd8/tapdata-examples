...
import io.tapdata.sdk.auth.Authentication;
import io.tapdata.sdk.auth.HttpBasicAuth;
import io.tapdata.sdk.auth.ApiKeyAuth;
import io.tapdata.sdk.auth.OAuth;
import io.tapdata.sdk.auth.RetryingOAuth;
import io.tapdata.sdk.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "http://106.75.162.192:3080";
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("", clientId, OAuthFlow.application, clientSecret, parameters);
        authentications.put(
                "OAuth2",
                retryingOAuth
        );
        httpClient = httpClient.newBuilder().addInterceptor(retryingOAuth).build();
    ...
    * Constructor for ApiClient to support access token retry on 401/403 configured with client ID, secret, and additional parameters
    */
    public ApiClient(String clientId, String clientSecret, String apiUrl, String authUrl) {
        init();

        basePath = apiUrl;

        RetryingOAuth retryingOAuth = new RetryingOAuth(authUrl, clientId, OAuthFlow.application, clientSecret, null);
        authentications.put(
            "OAuth2",
            retryingOAuth
        );
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/moa-v1.1.0-117-g6b02a67/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://106.75.162.192:3080
    ...
    public List<Pair> parameterToPair(Map<String, String> map) {
        List<Pair> params = new ArrayList<Pair>();
